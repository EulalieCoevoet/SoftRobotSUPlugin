...
class BeamProjectionDifferenceMultiMapping : public sofa::core::Multi2Mapping<TIn1, TIn2, TOut>
{
public:
...
#if !defined(SOFTROBOTSU_MAPPING_BEAMPROJECTIONDIFFERENCEMULTIMAPPING_CPP)
...
extern template class SOFA_SOFTROBOTSU_API BeamProjectionDifferenceMultiMapping< sofa::defaulttype::Rigid3Types, sofa::defaulttype::Rigid3Types, sofa::defaulttype::Rigid3Types >;
#endif
